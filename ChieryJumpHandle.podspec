#
#  Be sure to run `pod spec lint ChieryJumpHandle.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "ChieryJumpHandle", "ChieryJumpHandle/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "ChieryJumpHandle/**/*.h"
